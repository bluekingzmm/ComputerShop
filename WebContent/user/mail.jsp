	...
	<div class="login">
		<div class="wrap">
			<div class="col_1_of_login span_1_of_login">
				...
				<div class="button1"><a href="<c:url value="/user/register.jsp"/>"><input
						type="submit" name="Submit" value="创建新用户"></a></div>
				<div class="clear"></div>
		</div>
			<div class="col_1_of_login span_1_of_login">
				<div class="login-title">
					...
					<div id="loginbox" class="loginbox">
						<form action='<c:url value="/UserAction?operate=mail"></c:url>'
					...
					<input type="text" class="inputbox" autocomplete="off"
